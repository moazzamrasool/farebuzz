        ...
        <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;">
          ...
          <tr>
            <td style="padding:28px;">
              <h2 style="margin:0 0 12px;font-size:18px;">Hi {{ $booking->traveller_name }},</h2>
              <p style="font-size:14px;line-height:1.7;color:#444;">
                Here's your day-by-day trip itinerary for booking <strong>{{ $booking->booking_reference }}</strong>
                ({{ $booking->package_title }}), attached as a PDF.
              </p>
              <p style="font-size:12px;color:#aaa;margin-top:24px;">
                Have questions about your trip? Just reply to this email.
              </p>
            </td>
          </tr>
        </table>
