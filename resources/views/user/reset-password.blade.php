...
<head>
  ...
  <title>Reset Password – FareBuzzer</title>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .auth-field input {
      ...
      padding: 0 42px; font-size: 14px; font-family: 'Inter', sans-serif;
      ...
      <form action="{{ route('user.password.update') }}" method="POST" novalidate>
        ...
        <div class="auth-field">
          ...
          <input type="email" name="email" placeholder="Email Address"
            ...
            autocomplete="email" style="padding-left:42px;"/>
          @error('email')
        ...
        <div class="auth-field">
          ...
          <input type="password" name="password_confirmation" id="password_confirmation" placeholder="Confirm New Password"
            autocomplete="new-password"/>
          <i class="bi bi-eye-slash field-icon-toggle" id="toggleConfirmPassword"></i>
        </div>
