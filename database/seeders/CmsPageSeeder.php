...
class CmsPageSeeder extends Seeder
{
    ...
    {
        $pages = [
            ['slug' => 'about-us', 'title' => 'About Us', 'body' => '<p>FareBuzzer is your trusted travel companion for flights, hotels, holidays, trains and more. We partner with the best hotels, airlines and local experts to bring you curated travel experiences at the best prices.</p>'],
            ['slug' => 'careers', 'title' => 'Careers', 'body' => '<p>We are always looking for passionate people to join the FareBuzzer team. Check back soon for open roles, or write to us at careers@farebuzzertravel.com.</p>'],
            ...
            ['slug' => 'partner-with-us', 'title' => 'Partner With Us', 'body' => '<p>Run a hotel, resort or travel service? Partner with FareBuzzer to reach thousands of travellers. Write to us at partners@farebuzzertravel.com.</p>'],
            ...
            ['slug' => 'terms-of-service', 'title' => 'Terms of Service', 'body' => '<p>By using FareBuzzer, you agree to these terms of service governing bookings, payments, cancellations and use of our website.</p>'],
            ['slug' => 'cookie-policy', 'title' => 'Cookie Policy', 'body' => '<p>FareBuzzer uses cookies to improve your browsing experience, remember your preferences and analyse site traffic.</p>'],
            ['slug' => 'sitemap', 'title' => 'Sitemap', 'body' => '<p>An overview of all pages on FareBuzzer — Home, India Packages, International Packages, Activities, MICE, and more.</p>'],
        ];
